      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 lg:gap-16">
            <div>
              <h5 className="text-xs font-mono uppercase tracking-widest text-gray-400 mb-6">
                Platform
              </h5>
              <ul className="space-y-3">
                {links.platform.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm font-semibold text-gray-700 hover:text-[#1E4BB5] transition-colors flex items-center gap-1 group"
                    >
                      {link}
                      <ArrowUpRight
                        size={12}
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-xs text-gray-500 font-medium">
              ...
              <a
                ...
                className="text-gray-800 hover:text-[#1E4BB5] transition-colors font-bold"
              >
                Softexedge
              </a>
            </p>
